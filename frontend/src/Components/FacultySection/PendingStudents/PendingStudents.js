...
class PendingStudents extends Component {
  ...
  onActivityChange = (e) => {
    ...
    this.setState({ selectedActivity: activity, branchId: "" }, () => {
      $("#faculty-pending-students-branch").trigger("change");
    });
  };
  ...
  render() {
    ...
    if (
      ...
      table = (
        <Datatable id='facultyActivityPending' header={header}>
          {tableBody}
        </Datatable>
      );
    } else {
            ...
            <div className='form-group row mb-4'>
              ...
              <div className='col-sm-10'>
                <SingleDropdown
                  ...
                  id='faculty-pending-students-branch'
                              ...
                              <div className='form-group row mb-4'>
                                ...
                                <div className='col-sm-10'>
                                  <SingleDropdown
                                    ...
                                    id='faculty-pending-students-activity'
...
export default connect(mapStateToProps, mapDispatchToProps)(PendingStudents);
