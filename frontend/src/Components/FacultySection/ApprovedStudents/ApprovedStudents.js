...
class ApprovedStudents extends Component {
  state = {
    activityId: "",
    branchId: "",
  ...
  onActivityChange = (e) => {
    ...
    this.setState({ selectedActivity: activity, branchId: "" }, () => {
      $("#faculty-approved-students-branch").trigger("change");
    });
  };
  ...
  render() {
    ...
    if (
            ...
            <ul className='table-controls'>
              <li>
                <button
                  ...
                  onClick={() => this.facultyAction(a.Activity.id, false)}>
                  Reject
                </button>
              </li>
              <li>
      ...
      table = (
        <Datatable id='facultyActivityApproved' header={header}>
          {tableBody}
        </Datatable>
      );
    } else {
            ...
            <div className='form-group row mb-4'>
              ...
              <div className='col-sm-10'>
                <SingleDropdown
                  ...
                  id='faculty-approved-students-branch'
                              ...
                              <div className='form-group row mb-4'>
                                ...
                                <div className='col-sm-10'>
                                  <SingleDropdown
                                    ...
                                    id='faculty-approved-students-activity'
...
export default connect(mapStateToProps, mapDispatchToProps)(ApprovedStudents);
